<header class="page-header">
	<h2>Consulta de Sistemas Contratados - {NOME_EMPRESA}</h2>
</header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table">
                    <table class="table table-striped table-bordered table-hover table-condensed" id="tb_sistema_contratado">
						<thead>
                            <tr>
                                <th>Código</th>
                                <th>Descrição</th>
